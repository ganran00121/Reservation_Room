    ...
    setup(props, context) {
        ...
        onMounted(async () => {
            try {
                ...
                if (Array.isArray(response.data)) {
                    ...
                    console.log("dasdsad:::: :::: :", calendarOptions.events);
                } else {
        ...
        const clickTimelineButton = (clickinfo) => {
            ...
            if (timelineButton) {
                ...
                let calendarApi = context.$refs.calendar.getApi()
                calendarApi.next()
            }
        };
        return {
    ...
    <FullCalendar :options="calendarOptions" :ref="calendar">
        <template v-slot:eventContent='arg'>
            <div class=" w-full flex" @click="clicke_events(arg)">
                <svg class="my-auto" v-if="arg.view.type !== 'Timeline'" @click="log_options(arg)"
